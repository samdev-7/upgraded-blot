...
python3 firmware/tools/tune.py --port /dev/cu.usbmodemXXXX
python3 firmware/tools/tune.py --tests CA      # just axis accel + axis speed
python3 firmware/tools/tune.py --fine          # small steps from current values
```
